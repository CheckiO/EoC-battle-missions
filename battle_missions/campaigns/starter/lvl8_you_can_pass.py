...
MISSION_DATA[TERM.MAP_ELEMENTS] = [
    ...
    # ==========
    # CC
    command_center(level=1, tile_position=[20, 12], player_id=0),
    # Buildings
    ...
    # Towers
    sentry_tower(level=3, tile_position=[20, 0], player_id=0, code_id=TOWER_CODE_ID),
    sentry_tower(level=3, tile_position=[20, 26], player_id=0, code_id=TOWER_CODE_ID),
    sentry_tower(level=3, tile_position=[22, 33], player_id=0, code_id=TOWER_CODE_ID),
    ...
    rocket_tower(level=3, tile_position=[25, 1], player_id=0, code_id=TOWER_CODE_ID),
    rocket_tower(level=3, tile_position=[27, 0], player_id=0, code_id=TOWER_CODE_ID),
    rocket_tower(level=3, tile_position=[23, 23], player_id=0, code_id=TOWER_CODE_ID),
    rocket_tower(level=3, tile_position=[25, 24], player_id=0, code_id=TOWER_CODE_ID),
    rocket_tower(level=3, tile_position=[25, 30], player_id=0, code_id=TOWER_CODE_ID),
]
